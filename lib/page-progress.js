...
const PageProgress = Class({
    ...
    initialize: function(browser, options) {
        ...
        this.browser.messageManager.loadFrameScript(frameScriptUri, true);
    },

    start : function() {
        this.browser.messageManager.addMessageListener("net-log:PageProgress", this);
        this.browser.messageManager.sendAsyncMessage('progress:start');
    },

    stop: function() {
        this.browser.messageManager.sendAsyncMessage('progress:stop');
